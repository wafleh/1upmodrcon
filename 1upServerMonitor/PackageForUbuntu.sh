...
# Compile
#$FLEXSDKBIN/mxmlc -load-config+=obj/1upServerMonitorConfig.xml -debug=true -static-link-runtime-shared-libraries=true +configname=air -o $PROJPATH/bin/1upServerMonitor.swf
